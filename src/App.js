    ...
    <div className="w-screen h-screen flex flex-col justify-between items-center gap-16 bg-[#141414] py-10 px-6">
      ...
      <footer className="flex w-full justify-center">
        <span className="text-[#FCFBF7] text-lg text-center">
          ...
          it do not disappear. As developers, we have to do what we can. We beg
          all developers in the ecosystem. We are not asking you to donate
          ...
          reputation. Code for the millions in the cold, code for the childeren
          in the dark, code for the surviviors in despair, code with us, code
      ...
      <main className="flex-1 w-full flex flex-col items-center gap-8 overflow-auto scrollbar-hidden">
      ...
      <footer className="flex w-full justify-center">
        <span className="text-[#FCFBF7] text-lg text-center">
          ...
          <a
            href="https://github.com/Nova-Ratio/Code4them"
            target="_blank"
            rel="noreferrer"
          >
            Github Link Here
